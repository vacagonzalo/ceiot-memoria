...
\label{ch3Arq}
Esta sección trata sobre la conexión entre los servicios que se utilizan en este trabajo y la forma en la que se implementó su despliegue automático.
...
La entidad \emph{auth} solo tiene el método \emph{Post} en donde se le envía un usuario y contraseña.
...
La entidad \emph{devices} es la más extensa del servicio.
